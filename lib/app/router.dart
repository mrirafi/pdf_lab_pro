...
// Organize Tools
import 'package:pdf_lab_pro/screens/pdf_tools/merge_pdf_screen.dart';
...
import 'package:pdf_lab_pro/screens/pdf_tools/rotate_pdf_screen.dart';
  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (context, state) {
        ...
        return FastPDFViewer( // Changed to FastPDFViewer
          filePath: filePath,
          title: title,
        );
      },
